            ...
            new JsonAdapter<Float>() {
                ...
                public Float fromJson(JsonReader reader) throws IOException {
                    if (reader.peek() == JsonReader.Token.NULL) {
                        ...
                        // Double check for infinity after float conversion; many doubles >
                        // Float.MAX
                ...
                public void toJson(JsonWriter writer, Float value) throws IOException {
                    ...
                    // Use the Number overload so we write out float precision instead of double
                    // precision.
            ...
            new JsonAdapter<Short>() {
                ...
                public Short fromJson(JsonReader reader) throws IOException {
                    if (reader.peek() == JsonReader.Token.NULL) {
                        ...
                        return (short)
                                rangeCheckNextInt(
                                        reader, "a short", Short.MIN_VALUE, Short.MAX_VALUE);
                    }
                }
